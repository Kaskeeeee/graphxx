...
//                      const std::vector<std::string> &find, size_t
//                      &index_found, const size_t &pos = 0) {
...
//                                  size_t &end, const std::string
//                                  &open_delimiter, const std::string
//                                  &close_delimiter) {
...
//     max_close = input.find(close_delimiter, min_open +
//     close_delimiter.size());
//   } else {
